...
export interface IModelEvaluatedExamPaper extends Document {
...
const ModelEvaluatedExamPaperSchema: Schema = new Schema({
  owner_id: {
    type: String,
    unique: true,
    required: true,
...
const ModelEvaluatedExamPaperModel = mongoose.model<IModelEvaluatedExamPaper>('ModelEvaluatedExamPaper', ModelEvaluatedExamPaperSchema);

export default ModelEvaluatedExamPaperModel;