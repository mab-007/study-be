...
export interface IVerifiedExamPaper extends Document {
...
const VerifiedExamPaperModel = mongoose.model<IVerifiedExamPaper>('VerifiedExamPaper', ExamPaperSchema);

export default VerifiedExamPaperModel;